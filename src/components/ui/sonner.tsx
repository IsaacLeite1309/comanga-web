    ...
    <Sonner
      ...
      toastOptions={{
        classNames: {
          ...
          closeButton:
            "!left-auto !right-3 !top-1/2 !h-9 !w-9 !-translate-y-1/2 !translate-x-0 !border-0 !bg-transparent !text-slate-500 hover:!bg-black/5 hover:!text-slate-800 [&>svg]:!h-4 [&>svg]:!w-4 [&>svg]:!stroke-2",
